...
lock state machines of various sizes using a C++ testbench that reads input from
binary files generated by the AFL fuzzer. The Verilator simulation engine is
used to simulate the DUT.

Usage Example:
  exp001_lock_cpp_afl_runtime.py
"""
...
EXPERIMENT_BASE_NAME = "exp003-lock-runtime-cpp-afl-%dstates-%dwidth-%d"
