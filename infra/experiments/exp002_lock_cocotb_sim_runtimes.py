...
lock state machines of various sizes using a random lock sequence generator
defined in a cocotb (Python) testbench. The Verilator simulation engine is used
to simulate the DUT.

Usage Example:
  exp002_lock_cocotb_sim_runtime.py
"""
...
EXPERIMENT_BASE_NAME = "exp004-lock-runtime-cocotb-sim-%dstates-%dwidth-%d"
