...
# If FuseSoC is used to manage/generate HDL, use the name of the autogenerated
# configuration file to list required source files. (For OpenTitan cores.)
ifdef FUSESOC_CORE 
FUSESOC_TARGET := hdl/fusesoc_verilator.vc
VFLAGS += -f $(FUSESOC_TARGET)
...
#TODO(ttrippel): fix this hack to automatically extract KMAC HDL files 
ifeq ($(TOPLEVEL), kmac)
fusesoc:
